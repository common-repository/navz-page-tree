...
?>
<div class="wrap">
	<h1>Pages <a href="<?php echo admin_url('post-new.php?post_type=page'); ?>" class="page-title-action">Add New</a> <a href="#TB_inline?width=600&height=400&inlineId=page-tree-add-multiple" class="page-title-action thickbox" title="Add Multiple">Add Multiple</a></h1>
  <ul class="subsubsub">
	<?php
    $views = array();
    ...
    echo implode( " |</li>\n", $views ) . "</li>\n";
  ?>
  <li style="margin-left: 15px; vertical-align: top;"><button type="submit" class="button button-primary" value="Filter" disabled>Save Changes</button></li>
